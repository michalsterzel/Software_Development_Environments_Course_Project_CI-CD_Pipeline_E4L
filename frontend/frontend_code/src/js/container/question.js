...
const pdfFiles = importAll(require.context('../../public/file', false, /\.pdf$/));
...
this.handleShow = this.handleShow.bind(this);
  ...
  render() {
    let source = '../../public/file/'+this.props.detailsFile.split('/').pop()
    let cssColWidth = 3;
        ...
        >
          ...
          <Button variant="primary" onClick={this.handleShow} style={{float: "right"}}>
                  ...
                  <Modal size="lg" aria-labelledby="contained-modal-title-vcenter" centered show={this.state.show} onHide={this.handleClose} animation={false}>
                          ...
                          <Modal.Body>
                           <iframe src={source} width="100%" height="500px" frameBorder="0" allowFullScreen></iframe>
                           </Modal.Body>
                          <Modal.Footer>
